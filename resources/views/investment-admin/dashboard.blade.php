...
@section('content')
    ...
    <section class="content-header">
        <h1>INVESTMENTS ADMIN Dashboard</h1>
        <ol class="breadcrumb">
            <li class="active">
                <a href="#">
    ...
    <section class="content">
        <div class="row">
            ...
            <!-- Trans label piggy charts start's here-->
            ...
            <!-- Trans label subscribes charts starts here-->
            ...
            <!-- Trans label register users start's here-->
