    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                @include('investment-admin.layouts._messages')
                @include('investment-admin.layouts._notifications')
            ...
            <div class="page-sidebar  sidebar-nav">
                <div class="nav_icons">
                    <ul class="sidebar_threeicons">
                        <li>
                            <a href="/investment-admin/dashboard">
                ...
                <!-- BEGIN SIDEBAR MENU -->
                @include('investment-admin.layouts._left_menu')
                <!-- END SIDEBAR MENU -->
            </div>
        </section>
    </aside>
