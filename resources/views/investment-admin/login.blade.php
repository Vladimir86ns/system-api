        ...
        <div id="container_demo">
          ...
          <div id="wrapper">
            <div id="login" class="animate form">
              <form action="/investment-admin/sign-in" autocomplete="on" method="post" role="form" id="login_form">
                <h3 class="black_bg">
                  <!-- Add picture logo here when create it -->
                  <!-- <img src="{{ asset('assets/img/logo.png') }}" alt="josh logo"> -->
                  <br>Log In As Investment Admin</h3>
                  <!-- CSRF Token -->
              ...
              <div id="register" class="animate form">
                <form action="/investment-admin/sign-up" autocomplete="on" method="post" role="form" id="create_investments">
                  <h3 class="black_bg">
                    <!-- Add picture logo here when create it -->
                    <!-- <img src="{{ asset('assets/img/logo.png') }}" alt="josh logo"> -->
                    <br>Sign Up As Investments Admin</h3>
                    <!-- CSRF Token -->
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
