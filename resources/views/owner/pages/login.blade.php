      ...
      <div id="container_demo">
        ...
        <div id="wrapper">
          <div id="login" class="animate form">
            <form action="/owner/sign-in" autocomplete="on" method="post" role="form" id="login_form">
              <h3 class="black_bg">
                <!-- Add picture logo here when create it -->
                <!-- <img src="{{ asset('assets/img/logo.png') }}" alt="josh logo"> -->
                <br>Log In As Owner</h3>
                <!-- CSRF Token -->
            ...
            <div id="register" class="animate form">
              <form action="/owner/sign-up" autocomplete="on" method="post" role="form" id="register_here">
                <h3 class="black_bg">
                  <!-- Add picture logo here when create it -->
                  <!-- <img src="{{ asset('assets/img/logo.png') }}" alt="josh logo"> -->
                  <br>Sign Up As Owner</h3>
                  <!-- CSRF Token -->
                  <input type="hidden" name="_token" value="{{ csrf_token() }}" />
